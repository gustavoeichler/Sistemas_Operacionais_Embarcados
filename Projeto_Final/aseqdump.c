	...
	case SND_SEQ_EVENT_NOTEON:
		if (ev->data.note.velocity)
			printf("Note on                %2d, note %d, velocity %d\n",
			       ...
			       //tempo=(6400 -(50*ev->data.note.velocity));
			       tempo=((50*ev->data.note.velocity));
		 
		 if (ev->data.note.note == 55){
        		Apaga(2,tempo);
        		Apaga(7,tempo);
        		Apaga(8,tempo);
        		Apaga(9,tempo);

        }if (ev->data.note.note == 56){
		 		Cor(2,tempo,"Azul");
		 		Cor(7,tempo,"Azul");
		 		Cor(8,tempo,"Azul");
		 		Cor(9,tempo,"Azul");

        }if (ev->data.note.note == 57){
		 		Cor(2,tempo,"Vermelho");
		 		Cor(7,tempo,"Vermelho");
		 		Cor(8,tempo,"Vermelho");
		 		Cor(9,tempo,"Vermelho");

        }if (ev->data.note.note == 58){
		 		Cor(2,tempo,"Verde");
		 		Cor(7,tempo,"Verde");
		 		Cor(8,tempo,"Verde");
		 		Cor(9,tempo,"Verde");

        }if (ev->data.note.note == 59){
		 		Acende(2,tempo);
		 		Acende(7,tempo);
		 		Acende(8,tempo);
		 		Acende(9,tempo);
        ...
        }if (ev->data.note.note == 61){
        		Apaga(2,tempo);

        }if (ev->data.note.note == 62){
        		Cor(2,tempo,"Vermelho");

        }if (ev->data.note.note == 63){
        		Cor(2,tempo,"Verde");
        ...
        }if (ev->data.note.note == 66){
        		Cor(2,tempo,"Roxo");

        }if (ev->data.note.note == 67){
        		Cor(2,tempo,"Amarelo");

        }if (ev->data.note.note == 68){
        		Cor(2,tempo,"Rosa");

        }if (ev->data.note.note == 69){
		 		Acende(7,tempo);

        }if (ev->data.note.note == 70){
        		Apaga(7,tempo);

        }if (ev->data.note.note == 71){
        		Cor(7,tempo,"Vermelho");

        }if (ev->data.note.note == 72){
        		Cor(7,tempo,"Verde");

        }if (ev->data.note.note == 73){
        		Cor(7,tempo,"Azul");

        }if (ev->data.note.note == 74){
        		Cor(7,tempo,"Branco");

        }if (ev->data.note.note == 75){
        		Cor(7,tempo,"Roxo");

        }if (ev->data.note.note == 76){
        		Cor(7,tempo,"Amarelo");

        }if (ev->data.note.note == 77){
        		Cor(7,tempo,"Rosa");

        }if (ev->data.note.note == 78){
		 		Acende(8,tempo);

        }if (ev->data.note.note == 79){
        		Apaga(8,tempo);

        }if (ev->data.note.note == 80){
        		Cor(8,tempo,"Vermelho");

        }if (ev->data.note.note == 81){
        		Cor(8,tempo,"Verde");

        }if (ev->data.note.note == 82){
        		Cor(8,tempo,"Azul");

        }if (ev->data.note.note == 83){
        		Cor(8,tempo,"Branco");

        }if (ev->data.note.note == 84){
        		Cor(8,tempo,"Roxo");

        }if (ev->data.note.note == 85){
        		Cor(8,tempo,"Amarelo");

        }if (ev->data.note.note == 86){
        		Cor(8,tempo,"Rosa");

        }
        if (ev->data.note.note == 87){
		 		Acende(9,tempo);

        }if (ev->data.note.note == 88){
        		Apaga(9,tempo);

        }if (ev->data.note.note == 89){
        		Cor(9,tempo,"Vermelho");

        }if (ev->data.note.note == 90){
        		Cor(9,tempo,"Verde");

        }if (ev->data.note.note == 91){
        		Cor(9,tempo,"Azul");

        }if (ev->data.note.note == 92){
        		Cor(9,tempo,"Branco");

        }if (ev->data.note.note == 93){
        		Cor(9,tempo,"Roxo");

        }if (ev->data.note.note == 94){
        		Cor(9,tempo,"Amarelo");

        }if (ev->data.note.note == 95){
        		Cor(9,tempo,"Rosa");
